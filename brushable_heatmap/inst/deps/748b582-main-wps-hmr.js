...
var HeatmapD3 = /*#__PURE__*/function () {
  function HeatmapD3(el, props) {
    ...
    if (props.showPoints) {
      this.cells.append("circle").attr('cx', function (d) {
        return scaleX(d.x);
      }).attr('cy', function (d) {
        return scaleY(d.y);
    ...
    this.svg.call(d3__WEBPACK_IMPORTED_MODULE_0__["brush"]().extent([[0, 0], [this.width, this.height]]).filter(function (event) {
      return event.ctrlKey;
    }).on("start end", updateBrush));
  }
...
//# sourceMappingURL=748b582-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI3NDhiNTgyLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==