...
var HeatmapD3 = /*#__PURE__*/function () {
  function HeatmapD3(el, props) {
    ...
    var mousemove = function mousemove(d, object) {
      ...
      tooltipSvg.append("g").attr("transform", "translate(30," + plotHeight + ")").call(d3__WEBPACK_IMPORTED_MODULE_0__["axisBottom"](xBars)).append("text").attr("text-anchor", "middle").attr("fill", "black").attr("x", plotWidth / 2).attr("y", 30).text(props.histLabel);
...
//# sourceMappingURL=34220e3-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIzNDIyMGUzLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==