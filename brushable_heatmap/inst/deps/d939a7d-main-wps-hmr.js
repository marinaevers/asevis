...
var HeatmapD3 = /*#__PURE__*/function () {
  function HeatmapD3(el, props) {
    ...
    this.width = width;
    this.height = height;
    d3__WEBPACK_IMPORTED_MODULE_0__["select"](el).selectAll("*").remove(); // Add drawing area
    ...
    var g = this.svg.append("g"); // Draw axes
    ...
    var mousemove = function mousemove(d, object) {
      ...
      for (var i = 0; i < object.histValues.length; ++i) {
        var val = object.histValues[i][1];
      ...
      d3__WEBPACK_IMPORTED_MODULE_0__["select"](".tooltip").html(object.x + "," + object.y + "<br>Value: " + object.value + "<br><div id='tipDistribution'></div>").style("left", d.pageX + 10 + "px").style("top", d.pageY + 10 + "px");
      var tooltipSvg = d3__WEBPACK_IMPORTED_MODULE_0__["select"]("#tipDistribution").append("svg").attr("width", plotWidth + 40).attr("height", plotHeight + 40);
      var xBars = d3__WEBPACK_IMPORTED_MODULE_0__["scaleBand"]().range([0, plotWidth]).domain(object.histValues.map(function (d) {
        return d[0];
      })).padding(0.05);
      tooltipSvg.append("g").attr("transform", "translate(30," + plotHeight + ")").call(d3__WEBPACK_IMPORTED_MODULE_0__["axisBottom"](xBars).tickValues(xBars.domain().filter(function (d, i) {
        console.log(d);
        return !(i % 5);
      })).tickFormat(function (d) {
        return d3__WEBPACK_IMPORTED_MODULE_0__["format"](".2f")(d);
      })).append("text").attr("text-anchor", "middle").attr("fill", "black").attr("x", plotWidth / 2).attr("y", 30).text(props.histLabel);
      var yBars = d3__WEBPACK_IMPORTED_MODULE_0__["scaleLinear"]().domain([0, yMaxHist]).range([plotHeight, 0]);
      tooltipSvg.append("g").attr("transform", "translate(30,5)").call(d3__WEBPACK_IMPORTED_MODULE_0__["axisLeft"](yBars));
      tooltipSvg.selectAll("histBars").data(object.histValues).enter().append("rect").attr("x", function (d) {
        return xBars(d[0]) + 30;
      }).attr("y", function (d) {
        return yBars(d[1]);
      }).attr("width", xBars.bandwidth()).attr("height", function (d) {
...
//# sourceMappingURL=d939a7d-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJkOTM5YTdkLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==