...
var HeatmapD3 = /*#__PURE__*/function () {
  function HeatmapD3(el, props) {
    ...
    this.width = width;
    this.height = height;
    self.svg = d3__WEBPACK_IMPORTED_MODULE_0__["select"](el).append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // Add brushing
    ...
    var updateBrush = function updateBrush(event) {
      ...
      if (event.sourceEvent.shiftKey) {
        var coordinates = d3__WEBPACK_IMPORTED_MODULE_0__["pointer"](_this);
    ...
    var tooltip = this.svg.append('div').style("opacity", 0).attr("class", "tooltip").style("background-color", "white").style("border", "solid").style("border-width", "2px").style("border-radius", "5px").style("padding", "5px").style("position", "absolute"); // Three function that change the tooltip when user hover / move / leave a cell
    ...
    this.svg.append("g").attr("class", "brush").call(brush); // draw cells
...
//# sourceMappingURL=da16b3c-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJkYTE2YjNjLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==